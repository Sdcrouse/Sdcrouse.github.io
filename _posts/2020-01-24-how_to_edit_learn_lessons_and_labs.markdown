...
> **July 2020 update:** Github has been updated since I wrote this blog post. The Github images that I used are for an earlier version. I will make notes of significant visual changes where appropriate.
...
> **July 2020 update:** The green button now has a "download" (down-arrow over a horizontal line) icon next to the word "Code". It still works the same way as before.
...
> **July 2020 update:** There is no longer a **New pull request** button. Instead, click on the **Pull request** link (near the green **Code** button, next to **Compare**).
